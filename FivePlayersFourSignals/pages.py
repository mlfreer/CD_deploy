...
class OpinionPoll(Page):
    template_name = 'FivePlayersFourSignals/OpinionPoll.html'
    form_model = 'player'
    form_fields = ['opinion']
...
class OpinionResults(Page):
    template_name = 'FivePlayersFourSignals/OpinionPollResults.html'
    def vars_for_template(player):
...
class Disclosure(Page):
    ...
    template_name = 'FivePlayersFourSignals/Disclosure.html'
    form_model = 'player'
...
class Voting(Page):
    template_name = 'FivePlayersFourSignals/Vote.html'
    form_model = 'player'
    form_fields = ['vote']
    # include vars_for_template
    ...
    def before_next_page(self):
        if self.player.iteration > 0:
            self.player.iteration = 4 - self.player.iteration
...
class Results(Page):
    template_name = 'FivePlayersFourSignals/Results.html'
    def vars_for_template(player):
...
class FinalPage(Page):
    ...
    template_name = 'FivePlayersFourSignals/FinalResults.html'
