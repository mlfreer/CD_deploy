...
class OpinionPoll(Page):
    template_name = 'FivePFourSTwoR/OpinionPoll.html'
    form_model = 'player'
    form_fields = ['opinion']
...
class OpinionResults(Page):
    template_name = 'FivePFourSTwoR/OpinionPollResults.html'
    def vars_for_template(player):
...
class Disclosure(Page):
    ...
    template_name = 'FivePFourSTwoR/Disclosure.html'
    form_model = 'player'
...
class Voting(Page):
    template_name = 'FivePFourSTwoR/Vote.html'
    form_model = 'player'
    form_fields = ['vote']
    # include vars_for_template
...
class Results(Page):
    template_name = 'FivePFourSTwoR/Results.html'
    def vars_for_template(player):
...
class FinalPage(Page):
    ...
    template_name = 'FivePFourSTwoR/FinalResults.html'
