# Generated by Django 2.2.12 on 2022-04-26 18:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purple_votes', otree.db.models.IntegerField(null=True)),
                ('group_votes', otree.db.models.IntegerField(default=0, null=True)),
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='fivepfourstwor_info_group', to='otree.Session')),
            ],
            options={
                'db_table': 'FivePFourSTwoR_Info_group',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('round_number', otree.db.models.PositiveIntegerField(db_index=True, null=True)),
                ('session', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='fivepfourstwor_info_subsession', to='otree.Session')),
            ],
            options={
                'db_table': 'FivePFourSTwoR_Info_subsession',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='FivePFourSTwoR_Info.Group')),
                ('participant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='fivepfourstwor_info_player', to='otree.Participant')),
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='fivepfourstwor_info_player', to='otree.Session')),
                ('subsession', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='FivePFourSTwoR_Info.Subsession')),
            ],
            options={
                'db_table': 'FivePFourSTwoR_Info_player',
            },
        ...
        migrations.AddField(
            model_name='group',
            name='subsession',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='FivePFourSTwoR_Info.Subsession'),
        ),
    ]
