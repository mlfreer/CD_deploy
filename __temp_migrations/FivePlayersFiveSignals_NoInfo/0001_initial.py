# Generated by Django 2.2.12 on 2022-11-29 19:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='fiveplayersfivesignals_noinfo_group', to='otree.Session')),
            ],
            options={
                'db_table': 'FivePlayersFiveSignals_NoInfo_group',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('round_number', otree.db.models.PositiveIntegerField(db_index=True, null=True)),
                ('session', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='fiveplayersfivesignals_noinfo_subsession', to='otree.Session')),
            ],
            options={
                'db_table': 'FivePlayersFiveSignals_NoInfo_subsession',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('opinion', otree.db.models.IntegerField(choices=[[1, 'Orange'], [-1, 'Purple'], [0, 'Indifferent']], null=True, verbose_name='Which project do you prefer?')),
                ...
                ('vote', otree.db.models.IntegerField(choices=[[1, 'Orange'], [-1, 'Purple']], null=True, verbose_name='Which project would you like to get implemented?')),
                ...
                ('opinion_iteration3', otree.db.models.IntegerField(default=-2, null=True)),
                ('opinion_iteration4', otree.db.models.IntegerField(default=-2, null=True)),
                ('opinion_iteration5', otree.db.models.IntegerField(default=-2, null=True)),
                ...
                ('group', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='FivePlayersFiveSignals_NoInfo.Group')),
                ('participant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='fiveplayersfivesignals_noinfo_player', to='otree.Participant')),
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='fiveplayersfivesignals_noinfo_player', to='otree.Session')),
                ('subsession', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='FivePlayersFiveSignals_NoInfo.Subsession')),
            ],
            options={
                'db_table': 'FivePlayersFiveSignals_NoInfo_player',
            },
        ...
        migrations.AddField(
            model_name='group',
            name='subsession',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='FivePlayersFiveSignals_NoInfo.Subsession'),
        ),
    ]
