# Generated by Django 2.2.12 on 2021-07-15 18:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='collective_deliberation_infotreatment_group', to='otree.Session')),
            ],
            options={
                'db_table': 'collective_deliberation_infoTreatment_group',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('round_number', otree.db.models.PositiveIntegerField(db_index=True, null=True)),
                ('session', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='collective_deliberation_infotreatment_subsession', to='otree.Session')),
            ],
            options={
                'db_table': 'collective_deliberation_infoTreatment_subsession',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('opinion', otree.db.models.IntegerField(choices=[[1, 'Orange'], [-1, 'Gray'], [0, 'None']], null=True, verbose_name='Which project do you prefer?')),
                ...
                ('vote', otree.db.models.IntegerField(choices=[[0, 'Orange'], [1, 'Gray']], null=True, verbose_name='Which project would you like to get implemented?')),
                ...
                ('publicized_evidence', otree.db.models.IntegerField(default='None', null=True)),
                ...
                ('group', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='collective_deliberation_infoTreatment.Group')),
                ('participant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='collective_deliberation_infotreatment_player', to='otree.Participant')),
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='collective_deliberation_infotreatment_player', to='otree.Session')),
                ('subsession', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='collective_deliberation_infoTreatment.Subsession')),
            ],
            options={
                'db_table': 'collective_deliberation_infoTreatment_player',
            },
        ...
        migrations.AddField(
            model_name='group',
            name='subsession',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='collective_deliberation_infoTreatment.Subsession'),
        ),
    ]
